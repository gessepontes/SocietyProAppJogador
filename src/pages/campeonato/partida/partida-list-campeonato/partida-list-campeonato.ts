...
import { PartidaCampeonatoPage } from '../partida-list/partida-list';
import { NativeStorage } from 'ionic-native';

@Component({
    selector: 'page-partida-list-campeonato',
    templateUrl: 'partida-list-campeonato.html',
    providers: [SocietyService]
})
export class PartidaCampeonatoListPage {
    ...
    listPartidas(IDCampeonato, IDPessoa) {
        this.navCtrl.push(PartidaCampeonatoPage, { IDCampeonato: IDCampeonato, IDPessoa: IDPessoa});
    }
